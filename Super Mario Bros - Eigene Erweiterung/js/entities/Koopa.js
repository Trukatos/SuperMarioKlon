...
function KoopaBehavior() {
  ...
  this.handleNudge = function(us, them) {
  ...
  this.handleStomp = function(us, them) {
    if(this.state === STATE_WALKING) {
      this.hide(us);
    } else if (this.state === STATE_HIDING) {
      us.killable.kill();
